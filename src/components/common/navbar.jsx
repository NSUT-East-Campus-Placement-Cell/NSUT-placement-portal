...
const NavBar = () => {
  ...
  return <Navbar bg="light" expand="lg" className='navbar-nsut' sticky="top">
          <Navbar.Brand href="/"  >
            <img
              src="/nsut_logo.png"
        ...
        <Navbar.Collapse id="basic-navbar-nav">
          <Nav className="ml-auto" style={{color: "#000", fontWeight: 500 }}>
              ...
              <NavDropdown title="WHY NSUT?" className={`nav-link ${location.pathname.includes('why-nsut') ? 'active': ''}`} id='whyNSUT'>
