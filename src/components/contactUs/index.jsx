    ...
    return (<div className='contact-us'>
        ...
        <div className='content container' >
            <div className='address'>
                ...
                <h2>Our Address</h2>
                <p>Krishna Nagar Road, Near Chacha Nehru Bal Chikitsalaya, Geeta Colony, Delhi 110031</p>
            </div>
            <div className='email'>
        ...
        <div className='email-form container'>
            ...
            <Form onSubmit={async (event) => {
                ...
                <Form.Group controlId="name">
                    ...
                    <Form.Control value={name} onChange={(e) => setName(e.currentTarget.value)} type="text" placeholder="Enter name" required/>
                </Form.Group>
                <Form.Group controlId="formBasicEmail">
                    <Form.Label>Email address</Form.Label>
                    <Form.Control value={email} onChange={(e) => setEmail(e.currentTarget.value)} type="email" placeholder="Enter email" required/>
                </Form.Group>

                <Form.Group controlId="message">
                    <Form.Label>Message</Form.Label>
                    <Form.Control value={message} onChange={(e) => setMessage(e.currentTarget.value)} as="textarea" rows={3} required/>
                </Form.Group>
