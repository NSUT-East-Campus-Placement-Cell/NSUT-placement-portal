							...
							<Card border='dark' style={{ marginBottom: '5vh' }}>
								...
								<Card.Body>
									...
									<Card.Text>
										...
										Error aliquam ducimus quam modi pariatur quia ab et nulla
										voluptatum totam? Maiores, ipsa ad, mollitia, expedita earum
										eos itaque quia voluptas tempore pariatur quas sapiente
										ullam facere impedit aspernatur sunt fugit vitae delectus
										assumenda reprehenderit. Blanditiis eveniet tenetur
										voluptatum fugit quisquam.
									</Card.Text>
								</Card.Body>
							</Card>
						</Col>
						...
						<Col md={true}>
							<Card border='dark' style={{ marginBottom: '5vh' }}>
								...
								<Card.Body>
									...
									<Card.Text>
										Lorem ipsum dolor sit amet consectetur adipisicing elit.
										Esse alias labore, quibusdam eveniet magni doloremque atque
										nulla ipsam sit numquam harum tempore nisi porro debitis
										nostrum hic quia a dolor ducimus rem? Quidem eligendi
										possimus veritatis quos, repellendus molestias alias. Quae
										quisquam est perspiciatis dolorem! Dignissimos quis odio
										deserunt dolores.
									</Card.Text>
								</Card.Body>
							</Card>
