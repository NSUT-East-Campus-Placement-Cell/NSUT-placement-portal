  ...
  return (
      <div>
        ...
        <Container style={{marginTop:'5vh'}}>
          <p className='desc'></p>
          <h3 className='heading'>Graduate Courses</h3><p>NSUT East Campus offers courses at the undergraduate and Graduate level in streams of Engineering and Technology.The institute is well known for offering traditional B.Tech and M.Tech Programs in domains of Computer Science and Electronics. NSUT East Campus has now introduced innovative and popular Undergraduate courses such as CSDA, ECAM and Graduate courses in Information Security and Digital Communication.</p>
          <Row>
            <Col lg={true}>
              <Card className='xl'>
                <Card.Body>
                  ...
                  <Card.Text>
                    ...
                    <p>Data is the new gold and keeping that in mind this course has been designed in a manner that promises to teach students how to reap benefits of big data for businesses and give them a global understanding of the opportunities the technology presents. This course shall impart training in statistics, Data Mining, Data Warehousing, Data Visualization etc. This would help in understanding and handling huge amounts of Data of an organization and helping them make informed decisions.</p>   
                  </Card.Text>
                </Card.Body>
              </Card>
            </Col>
            ...
            <Col lg={true}>
              <Card className='md'>
                <Card.Body>
                  ...
                  <Card.Text>
                    <p>This course focusses on both theoretical and practical exposure to students in communication and networking areas. It is designed to offer a modern, industry-oriented education in communication applications. This specialized programme focuses on instilling skills related to design, development, observation, and application of Digital Communication circuits & systems.</p>
                  </Card.Text>
                </Card.Body>
              </Card>
            </Col>
